...
module.exports = class Main {
    ...
    constructor() {
        ...
        this.loadConfig().then(() => {
            this.twitterHandler = new Twitter(this.generator, this.twitterAPI, this.utils);
            this.eventHandler = new Event(this.twitterHandler, this.dataHandler, this.generator, this.utils);
