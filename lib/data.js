...
module.exports = class Data {
    ...
    saveTweetData(newData) {
        return new Promise((resolve, reject) => {
            fs.readFile(this.DATABASE_FILE, (error, data) => {
                if (error) {
                    if (error.code === 'ENOENT') {
                        // Resolve with new data if a database doesn't exist
                        resolve(newData);
                    } else {
                        reject(error);
                    }
                ...
                // Otherwise insert new data into existing data:
                ...
                for (let key in newData) {
                    ...
                    // .. else declare new array in existing data
                    } else {
            ...
            return new Promise((resolve, reject) => {
                fs.writeFile(this.DATABASE_FILE, JSON.stringify(dataToSave), (error, data) => {
                    if (error) {
