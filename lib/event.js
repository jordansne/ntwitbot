...
module.exports = class Event {
    ...
    retrieveUserTweets(userData, tweetsToProcess, done) {
        this.twitterPkg.get('statuses/user_timeline', userData, (error, tweets, response) => {
            ...
            if (tweets.length > 0) {
                console.log("[INFO] Update: Found %d new tweets from user: %s", tweets.length, userData.user_id);
                ...
                console.log("[INFO] Update: No new tweets from user: %s", userData.user_id);
            }
