...
module.exports = class Event {
    ...
    checkMentions() {
        ...
        this.twitterPkg.get('statuses/mentions_timeline', mentionData, function(error, mentions, response) {
            if (error) {
    ...
    checkTrackedTweets() {
        ...
        this.twitterPkg.get('friends/ids', data, function(error, result, response) {
            ...
            for (let userID in self.trackedUsers) {
                ...
                self.twitterPkg.get('statuses/user_timeline', userData, function(error, tweets, response) {
